...
class Pendaftar extends CI_controller {
    ...
    public function __construct() {
        ...
        $this->load->model('admin/pendaftar_model');
    }
    
    public function index() {
        $query = $this->pendaftar_model->data_pendaftar();
        $data = array('title'=>'Manajemen Pendaftar', 'pendaftar'=>$query, 'isi'=>'admin/pendaftar/pendaftar_view');
