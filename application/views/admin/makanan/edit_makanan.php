...
<hr width="100%">
<form action="<?php echo base_url() ?>admin/makanan/edit" method="post">
                
               <div class="form-group" style="width: 360px">
                   <div class="input-group">
                      <div class="input-group-addon"><span class="glyphicon glyphicon-barcode" aria-hidden="true"></span></div>
                      <input type="text" class="form-control" name="id_menu" placeholder="Id Menu" value="<?php echo $detail['id_menu'] ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group" style="width: 360px">
                     <div class="input-group">
                         ...
                         <input type="text" class="form-control" name="nama_menu" placeholder="Nama Menu" value="<?php echo $detail['nama_menu'] ?>" required />
                    </div>
                </div>
				...
				<div class="form-group" style="width: 360px">
                   <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="harga_satuan" placeholder="Harga Satuan" value="<?php echo $detail['harga_satuan'] ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group" style="width: 360px">
                   <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="img_menu" placeholder="Nama_Gambar.jpg/png" value="<?php echo $detail['img_menu'] ?>"required />
                    </div>
                </div>
