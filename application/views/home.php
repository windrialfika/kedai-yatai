                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <span>Kami Menyediakan</span><br>
                                <span class="cd-words-wrapper">
                                    <b class="is-visible">MAKANAN</b>
                                    <b>TUSUKAN</b>
                                    <b>MINUMAN</b>
                                </span>
                                </h1>
                                ...
                                <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
                                    Kedai Yatai Tebet menjual berbagai macam masakan Jepang. Kami berusaha selalu memberikan pelayanan yang memuaskan kepada pelanggan.
                                </h2>
                                <a href="/kedai-yatai/menu" class="btn btn-dafault btn-home wow fadeInUp animated" data-wow-delay=".9s">Pesan Sekarang</a>
